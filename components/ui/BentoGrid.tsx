...
export const BentoGridItem = ({
    ...
    const handleClick = () => {
        navigator.clipboard.writeText("aliabdelahdi010@gmail.com")
        setCopied(true)
    }
    return (
        <div
        ...
        >
            <div className={`${id === 6 && "flex justify-center "} h-full`}>
                ...
                <div>
                    ...
                    <div className={cn(
                        titleClassName, "group-hover/bento:translate-x-2 transition-200 transition relative md:h-full min-h-40 flex flex-col px-4 p-5 lg:p-10"
                    )}>
                        ...
                        {id === 3 && (
                            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                                <div className="flex flex-col gap-x-3 gap-y-2 lg:gap-x-8 lg:gap-y-4">
                                ...
                                <div className="flex flex-col gap-x-3 gap-y-2 lg:gap-x-8 lg:gap-y-4">
                                    ...
                                    {["GSAP", "AWS", "Neon Postgres"].map((item) => (
                                        <span key={item} className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e] ">
                                            {item}
                                        </span>
                                    ))}
